        ...
        <div class="flex w-full justify-center gap-1.5">
            {#each row as key}
                <button
                    ...
                    class="key relative flex h-10 cursor-pointer items-center justify-center border pt-1 text-[1.05rem] font-medium active:scale-90 {pressed.includes(
                        key.code,
                    )
            ...
            {#if row === ROWS[ROWS.length - 1]}
                <button
                    ...
                    class="key relative flex h-10 cursor-pointer items-center justify-center border border-line bg-bg text-[1.05rem] hover:bg-fg/10 active:scale-90 active:border-white active:bg-white active:text-black"
                >
