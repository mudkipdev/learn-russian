...
<main class="w-[min(96vw,1900px)]">
    ...
    <div class="grid gap-4 lg:grid-cols-[340px_1fr] xl:h-[calc(100dvh-6rem)] xl:grid-cols-[1fr_640px_1fr]">
                    ...
                    {#each filterGroups as group}
                        <div class="mb-5 last:mb-0">
                            ...
                            <div class="flex flex-wrap gap-2">
                                {#each group.topics as topic}
                                    <button
                                        class="cursor-pointer rounded-md px-3 py-1 text-[0.8rem] font-medium transition-all duration-100 active:scale-95 {enabledFilters.includes(
                                            topic.key,
                                        )
                                            ? 'bg-fg/20 text-fg'
                                            : 'bg-fg/10 text-muted'} hover:scale-105"
        ...
        <div class="relative rounded-lg border border-line bg-surface p-12 text-center xl:flex xl:flex-1 xl:flex-col xl:justify-center">
            <div
